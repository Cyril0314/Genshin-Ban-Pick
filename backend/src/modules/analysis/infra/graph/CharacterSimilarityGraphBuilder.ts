// backend/src/modules/analysis/infra/graph/CharacterSimilarityGraphBuilder.ts
...
export default class CharacterSimilarityGraphBuilder {
    ...
    async build(
        ...
        // 相似度分析
        const mode = 'ochiai';
        const similarityMatrix = this.squareSimilarityMatrixBuilder.build(characterCooccurrenceMatrix, mode, pickCounts);
