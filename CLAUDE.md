...
- CORS allow-list is hard-coded in `backend/src/index.ts` and `modules/socket/index.ts` (`http://localhost:5173`, `http://54.224.88.154:3000`) — update both if origins change.
